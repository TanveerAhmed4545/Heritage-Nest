...
import p2 from "../../assets/images/bg22.jpg";
import p3 from "../../assets/images/bg25.jpg";
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <h2 className="text-xl md:text-2xl font-bold">New Listed Properties</h2>
      ...
      <div className="carousel w-full pt-5 ">
        <div id="slide1" className="carousel-item relative w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 w-full md:grid-cols-3 px-5  gap-6">
            <Link to={"/details"}>
              <div className=" shadow-sm overflow-hidden bg-[#F9FAFB]">
